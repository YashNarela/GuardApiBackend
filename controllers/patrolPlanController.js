// // controllers/patrolPlanController.js
...
//     if (!planName || !shiftId || !checkpoints || checkpoints.length === 0) {
//       return res
//         .status(400)
//         .json(
//           new ApiResponse(
//             false,
//             "Plan name, shift, and checkpoints are required"
//           )
//         );
//     }
...
//     // Verify shift belongs to supervisor's company
//     const shift = await Shift.findOne({
//       _id: shiftId,
//       createdBy: req.user.id, // supervisor's company
//     });
...
//     // Verify guards belong to this supervisor
//     const guards = await User.find({
//       _id: { $in: assignedGuards },
...
//       return res
//         .status(400)
//         .json(new ApiResponse(false, "Some guards don't belong to your team"));
//     }
...
//     console.log('campany qr', qrCodes);
...
//         qrId: cp.qrId,
//         siteId: cp.siteId,
//         expectedTime: cp.expectedTime || 5, // default 5 minutes
//       })),
//       assignedGuards,
//       frequency,
//       shift: shiftId,
...
//       .status(201)
//       .json(
//         new ApiResponse(true, "Patrol plan created successfully", {
//           plan: populatedPlan,
//         })
//       );
//   } catch (err) {
...
//     const plans = await PatrolPlan.find({ createdBy: req.user.id })
//       .populate("assignedGuards", "name email")
//       .populate("shift", "startTime endTime shiftType")
...
//     const total = await PatrolPlan.countDocuments({ createdBy: req.user.id });
...
//     if (checkpoints) updateData.checkpoints = checkpoints;
//     if (assignedGuards) updateData.assignedGuards = assignedGuards;
//     if (frequency) updateData.frequency = frequency;
//     if (isActive !== undefined) updateData.isActive = isActive;
//     if (shiftId) updateData.shift = shiftId; // 👈 map properly
...
//       return res
//         .status(404)
//         .json(new ApiResponse(false, "Patrol plan not found"));
//     }

//     return res
//       .status(200)
//       .json(new ApiResponse(true, "Patrol plan updated", { plan }));
//   } catch (err) {
//     return res.status(500).json(new ApiResponse(false, err.message));
//   }
// };
...
//     return res
//       .status(200)
//       .json(new ApiResponse(true, "Your patrol plans", { plans }));
//   } catch (err) {
//     return res.status(500).json(new ApiResponse(false, err.message));
//   }
// };
